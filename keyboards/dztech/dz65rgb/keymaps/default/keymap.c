...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_65_ansi(
        ...
        _______,  _______,        KC_MS_UP,   KC_MS_BTN1,   KC_MS_BTN2, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MUTE,
        _______,  KC_MS_LEFT,   KC_MS_DOWN,  KC_MS_RIGHT,      _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_VOLU,
